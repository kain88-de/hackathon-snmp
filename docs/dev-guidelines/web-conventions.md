# OIDviz web conventions

Stack: **Vue 3 + TypeScript + Bun + Vite**

Style and architecture guidance for this package. Nothing here is CI-gated —
see [`web-guardrails.md`](web-guardrails.md) for what actually fails `just ci`.
